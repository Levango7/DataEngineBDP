  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/views/Workspaces.vue',
        'src/views/Projects.vue',
        'src/views/Integrate.vue',
        'src/views/Develop.vue',
        'src/views/Sql.vue',
        'src/views/SqlWorkbench.vue',
        'src/views/Govern.vue',
        'src/views/Quality.vue',
        'src/views/Lineage.vue',
        'src/views/Sec.vue',
        'src/views/Vector.vue',
        'src/views/Kb.vue',
        'src/views/Llmops.vue',
        'src/views/Gateway.vue',
        'src/views/Analyze.vue',
        'src/views/Ops.vue',
        'src/views/Account.vue',
        'src/views/Admin.vue',
        'src/views/Standard.vue',
        'src/views/TemplateMarket.vue',
        'src/views/AssetMarket.vue',
        ...
        'src/views/QuotaManagement.vue',
        'src/views/WorkspaceManagement.vue',
        // 关键子视图
        'src/views/dev/DevSched.vue',
        'src/views/dev/DevMl.vue',
        'src/views/engine/EngSpark.vue',
        'src/views/engine/EngFlink.vue',
        'src/views/govern/GovernMeta.vue'
      ],
      exclude: [
        'src/**/*.d.ts',
        'src/**/*.test.ts',
