    ...
    <div class="card" style="margin-top: 14px">
      <h3>
        ...
        <span v-if="healthSummary" class="health-summary-meta">
          ...
          <span v-if="healthSummary.warn">
            · {{ healthSummary.warn }} {{ t('ops.healthMeta.warn') }}
          </span>
          <span v-if="healthSummary.down" class="health-down">
            · {{ healthSummary.down }} {{ t('ops.healthMeta.down') }}
          </span>
          ）
        </span>
      </h3>
