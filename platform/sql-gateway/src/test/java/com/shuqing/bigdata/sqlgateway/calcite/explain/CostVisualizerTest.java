...
import com.shuqing.bigdata.sqlgateway.calcite.rule.PredicateType;
...
class CostVisualizerTest {
    ...
    void testSourceCost() {
        BaseAdapter adapter = new BaseAdapter() {
            ...
            @Override public com.shuqing.bigdata.sqlgateway.parser.SqlDialect getDialect() { return com.shuqing.bigdata.sqlgateway.parser.SqlDialect.DORIS; }
        };
    ...
    void testFindAdapterNullConfig() {
        BaseAdapter adapter = new BaseAdapter() {
            ...
            @Override public com.shuqing.bigdata.sqlgateway.parser.SqlDialect getDialect() { return null; }
        };
        CustomRelNode node = CustomRelNode.of(CustomRelNode.Op.TABLE_SCAN)
                .setTableName("t").setSourceName("doris");
        CostVisualizer v = new CostVisualizer();
