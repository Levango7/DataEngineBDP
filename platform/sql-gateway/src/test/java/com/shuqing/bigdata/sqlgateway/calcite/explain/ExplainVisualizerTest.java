...
import com.shuqing.bigdata.sqlgateway.calcite.CalciteOptimizer;
...
class ExplainVisualizerTest {
    ...
    private BaseAdapter createStubAdapter() {
        ...
        return new BaseAdapter() {
            ...
            @Override public com.shuqing.bigdata.sqlgateway.parser.SqlDialect getDialect() {
                return com.shuqing.bigdata.sqlgateway.parser.SqlDialect.DORIS;
            }
        };
    }
}