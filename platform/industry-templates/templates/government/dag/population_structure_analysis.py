...
dag = DAG(
    ...
    description=(
        "人口结构分析 DAG：从 population_base 聚合，" "计算人口结构/年龄/性别/学历/就业多维分布，写入 5 张汇总表"
    ),
...
notify_dashboard = PythonOperator(
    ...
    python_callable=lambda: print(f"[7] 人口结构分析完成，通知 Superset Dashboard 刷新: biz_date={BIZ_DATE}"),
    dag=dag,
)
