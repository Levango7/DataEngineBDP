package com.shuqing.bigdata.encaps.security.facade.controller;

import com.shuqing.bigdata.encaps.security.facade.SecurityFacade;
import com.shuqing.bigdata.encaps.security.facade.assessment.AssessmentReport;
import com.shuqing.bigdata.encaps.security.facade.assessment.AssessmentType;
import com.shuqing.bigdata.encaps.security.facade.audit.AuditEvent;
import com.shuqing.bigdata.encaps.security.facade.audit.AuditFacade;
import com.shuqing.bigdata.encaps.security.facade.audit.AuditLevel;
import com.shuqing.bigdata.encaps.security.facade.auth.AuthResult;
import com.shuqing.bigdata.encaps.security.facade.evidence.EvidenceItem;
import com.shuqing.bigdata.encaps.security.facade.mask.MaskFacade;
import com.shuqing.bigdata.encaps.security.facade.mask.MaskType;
 ...
 *
 * <h3>认证</h3>
 * <p>所有端点均要求 JWT 认证（由 {@link com.shuqing.bigdata.encaps.security.JwtAuthFilter} 处理），
...
public class SecurityFacadeController {
     ...
     * 导出测评报告。
     *
     * <p>请求体：{@code {"type": "dengbao-2.0", "systemName": "数擎大数据平台"}}</p>
     *
     * @param request 导出请求
     * @return 报告路径与摘要
