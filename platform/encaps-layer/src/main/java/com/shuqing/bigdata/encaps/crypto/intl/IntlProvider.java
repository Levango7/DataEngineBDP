 ...
 *
 * <h3>SPI 注册</h3>
 * <p>通过 {@code META-INF/services/com.shuqing.bigdata.encaps.crypto.CryptoProvider}
 * 注册，{@link com.shuqing.bigdata.encaps.crypto.CryptoSpiFactory} 按 Profile=international
 * 自动加载本类。</p>
 *
 * <h3>线程安全</h3>
