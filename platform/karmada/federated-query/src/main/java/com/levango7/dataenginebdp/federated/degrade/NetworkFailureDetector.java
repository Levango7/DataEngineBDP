...
public class NetworkFailureDetector {
    ...
    private final com.levango7.dataenginebdp.federated.config.FederatedQueryProperties props;
    private final ConcurrentHashMap<String, ClusterState> states = new ConcurrentHashMap<>();

    public NetworkFailureDetector(com.levango7.dataenginebdp.federated.config.FederatedQueryProperties props) {
        this.props = props;
    }
