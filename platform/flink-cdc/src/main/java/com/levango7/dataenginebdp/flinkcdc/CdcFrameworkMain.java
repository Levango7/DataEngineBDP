...
import com.levango7.dataenginebdp.flinkcdc.config.CdcYamlConfig;
 ...
 * <p>用法：</p>
 * <pre>{@code
 * flink run -c com.levango7.dataenginebdp.flinkcdc.CdcFrameworkMain flink-cdc.jar --config cdc-mysql.yaml
 * }</pre>
 *
 * <p>支持参数：</p>
 * <ul>
