...
func TestLoad_EnvOverride(t *testing.T) {
	_ = os.Setenv("STORE_TYPE", "milvus")
	_ = os.Setenv("VECTOR_ENGINE_PORT", "9090")
	_ = os.Setenv("DEFAULT_TOP_K", "50")
	_ = os.Setenv("MAX_VECTOR_DIM", "4096")
	_ = os.Setenv("MILVUS_HOST", "milvus.example.com")
	_ = os.Setenv("MILVUS_PORT", "19531")
	_ = os.Setenv("MILVUS_USERNAME", "admin")
	_ = os.Setenv("MILVUS_PASSWORD", "secret")
	_ = os.Setenv("MILVUS_DATABASE", "testdb")
	defer func() {
		_ = os.Unsetenv("STORE_TYPE")
		_ = os.Unsetenv("VECTOR_ENGINE_PORT")
		_ = os.Unsetenv("DEFAULT_TOP_K")
		_ = os.Unsetenv("MAX_VECTOR_DIM")
		_ = os.Unsetenv("MILVUS_HOST")
		_ = os.Unsetenv("MILVUS_PORT")
		_ = os.Unsetenv("MILVUS_USERNAME")
		_ = os.Unsetenv("MILVUS_PASSWORD")
		_ = os.Unsetenv("MILVUS_DATABASE")
	}()
...
func TestLoad_InvalidInt(t *testing.T) {
	_ = os.Setenv("DEFAULT_TOP_K", "not-a-number")
	_ = os.Setenv("MAX_VECTOR_DIM", "-1")
	defer func() {
		_ = os.Unsetenv("DEFAULT_TOP_K")
		_ = os.Unsetenv("MAX_VECTOR_DIM")
	}()
