...
- 当前版本：**v2.0.0（已发布 GA，2026-08-08）**，v2.1 生产化加固进行中
- 工程成熟度：综合评分 92/100 (A)，886 后端测试 + 155 前端测试全通过，7 条端到端链路落地（详见 [审核报告](docs/PROJECT-AUDIT-REPORT.md)）
- 开源协议：Apache License 2.0

> ℹ️ **状态说明**：本项目由 AI 辅助开发（华为云码道(CodeArts)代码智能体），经人工审查与验证。
> v2.0 GA 已完成核心组件生产化（封装层 / SQL 网关 / 规则引擎 / 治理闭环 / 安全合规 / 镜像签名），
