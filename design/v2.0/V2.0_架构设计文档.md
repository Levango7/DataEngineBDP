...
| 模块 ID | L2.12 |
| 模块名 | 实时入仓管道 |
| 实现技术 | Flink 1.20 CDC + Iceberg V2 + Kafka 3.6 |
...
| L2.12 | 实时入仓管道 | Flink CDC + Iceberg V2 | Flink 1.20 + Iceberg 1.5 | Debezium + Spark Structured Streaming | Flink exactly-once + Iceberg V2 upsert 原生支持 |
