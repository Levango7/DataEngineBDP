...
app.kubernetes.io/name: {{ include "jupyter.name" . | quote }}
...
ConfigMap name.
*/}}
{{- define "jupyter.configmapName" -}}
{{- printf "%s-config" (include "jupyter.fullname" .) -}}
{{- end -}}

{{/*
Service name.
*/}}
{{- define "jupyter.serviceName" -}}
{{- include "jupyter.fullname" . -}}
{{- end -}}
