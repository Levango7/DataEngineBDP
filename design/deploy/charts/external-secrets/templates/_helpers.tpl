...
app.kubernetes.io/name: {{ include "external-secrets.name" . | quote }}
...
ConfigMap name.
*/}}
{{- define "external-secrets.configmapName" -}}
{{- printf "%s-config" (include "external-secrets.fullname" .) -}}
{{- end -}}

{{/*
Service name.
*/}}
{{- define "external-secrets.serviceName" -}}
{{- include "external-secrets.fullname" . -}}
{{- end -}}
