...
使用 400 / 500 / 600 / 700 四档字重，禁止 300 等中间字重，保证层次清晰且渲染一致。

| 字重 | 语义 | 用途 |
| --- | --- | --- |
| 400（Regular） | 正文常规 | 正文、辅助文字、侧边栏导航（非激活） |
| 500（Medium） | 强调常规 | 按钮文字、表单标签、页脚小字等强调但非标题的文字 |
| 600（Semibold） | 次级标题 | 区块标题 H2、卡片标题 H3、表头、激活态导航 |
| 700（Bold） | 主标题 | 页面标题 H1 |
