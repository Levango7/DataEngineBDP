...
| **M4** V2.0 Phase 2+RC | 2026-08-08 | 18 任务 220 人天，微调→评测→部署闭环，等保三级整改，发布路径 | T049 V2.0 RC 发布（tag v2.0.0，GA 定级已修订为 RC，见 ERRATUM.md） |
...
| **M7** Spring Boot 3.2.x 维护 | 2026-09-01 | 3.2.x 稳定版维护 | 全量测试通过，覆盖率门禁 35/15→40/18 实化 |
...
**当前 HEAD**：`01ff2e5c` feat(i18n): DevMl 三个子组件词条化（2026-09-04）
