...
- 详细设计文档 43 份（49 模块 - 6 合并详设 + 部署清单 + 端到端 PoC + 控制台信息架构 + 运营后台实现落地）。
- 部署清单 46 个 Chart 条目（49 - 3 归并：L3.5→L5.1、L3.6→L5.2、L3.7→X2）。
- **禁止**：沿用"41 模块"旧口径。
...
> 本文件由组A-文档一致性修复任务（task 51）创建，依据《数擎大数据平台_全面评估报告.md》P0/P1 问题清单。