...
class HealthControllerTest {
    ...
    void health_shouldReturnUpStatus() throws Exception {
        mockMvc.perform(get("/api/v1/health"))
                ...
                .andExpect(jsonPath("$.service").value("encaps-layer"))
                .andExpect(jsonPath("$.version").value("unknown"))
                .andExpect(jsonPath("$.details.tenantCount").value(0));
    }
    ...
    @Test
    @DisplayName("GET /api/v1/health/readiness — 就绪探针返回UP与租户计数")
    void readiness_shouldReturnUpWithTenantCount() throws Exception {
