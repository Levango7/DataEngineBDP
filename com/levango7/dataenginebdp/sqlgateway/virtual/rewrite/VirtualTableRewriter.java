package com.shuqing.bigdata.sqlgateway.virtual.rewrite;

import com.shuqing.bigdata.sqlgateway.security.TenantContext;
import com.shuqing.bigdata.sqlgateway.virtual.VirtualTableDefinition;
import com.shuqing.bigdata.sqlgateway.virtual.VirtualTableService;
    ...
    public RewriteResult rewrite(String sql) {
        ...
        for (String tableName : tableNames) {
            ...
            if (vt.needsMaterialization() && vt.getMaterializedTableName() != null) {
                String materializedName = com.shuqing.bigdata.sqlgateway.virtual.materialize
