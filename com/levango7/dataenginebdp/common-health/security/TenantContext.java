 ...
 *
 * <p><b>使用说明</b>：本类由 common-health 共享模块提供，供各微服务统一复用，
 * 替代散布在各模块 {@code security} 包下的同名副本。各模块如需切换到公共版本，
 * 只需将 {@code import} 路径改为 {@code com.shuqing.bigdata.common.health.security.TenantContext}
 * 并确保 build.gradle 已依赖 {@code project(':common-health')}。</p>
 *
 * @since 1.1.0
 */
