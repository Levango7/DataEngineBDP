package com.shuqing.bigdata.finops.dashboard.indicator;
...
/**
 * FinOps 看板 Actuator readiness 健康指示器。
 *
 ...
 * 探测 Prometheus 数据源连通性，不可用时返回 DOWN 供 K8s 摘除流量。</p>
 *
 * <p>bean 名 {@code finopsDashboardReadinessIndicator} 以 {@code readinessIndicator} 结尾，
 * Spring Boot 3.x 自动将其归入 readiness health group。</p>
 *
 * @author shuqing-bigdata
 */
@Component
public class FinopsDashboardReadinessIndicator extends ReadinessHealthIndicator {
     ...
     * 构造指示器。
     *
     * @param prometheusQueryClient Prometheus 查询客户端，用于探测数据源连通性
     */
    public FinopsDashboardReadinessIndicator(PrometheusQueryClient prometheusQueryClient) {
