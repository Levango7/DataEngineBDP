...
/**
 * FinOps 看板 Actuator liveness 健康指示器。
 *
 ...
 *
 * <p>bean 名 {@code finopsDashboardLivenessIndicator} 以 {@code livenessIndicator} 结尾，
 * Spring Boot 3.x 自动将其归入 liveness health group。</p>
 *
 * @author shuqing-bigdata
 */
@Component
public class FinopsDashboardLivenessIndicator extends LivenessHealthIndicator {
